...
<div id="list-room" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="photo" title="${message(code: 'room.photo.label', default: 'Photo')}"/>
        ...
        <g:each in="${roomInstanceList}" status="i" var="roomInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${roomInstance.id}">${fieldValue(bean: roomInstance, field: "name")}</g:link></td>

                <td><img width="120" src="${createLink(action: 'displayLogo', id: roomInstance?.id)}"/></td>
