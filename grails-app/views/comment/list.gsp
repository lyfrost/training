			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="comment.news.label" default="News" /></th>
				...
				<g:each in="${commentInstanceList}" status="i" var="commentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${commentInstance.id}">${fieldValue(bean: commentInstance, field: "title")}</g:link></td>
						...
						<td>${fieldValue(bean: commentInstance, field: "news")}</td>
