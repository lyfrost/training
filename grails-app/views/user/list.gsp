<%@ page import="resokaskus.training.User" %>
<!doctype html>
<html>
<head>
...
<div id="list-user" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="prename" title="${message(code: 'user.prename.label', default: 'Prename')}"/>
            ...
            <g:sortableColumn property="KTP" title="${message(code: 'user.KTP.label', default: 'KTP')}"/>
